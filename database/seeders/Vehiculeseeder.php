...
class Vehiculeseeder extends Seeder
{
    ...
    public function run(): void
    {
        $vehicules = [
            [
                ...
                'image' => 'storage/app/public/categorie_vehicules/pneu_tourisme_1.jpg',
            ],
            [
                ...
                'description' => 'Pneus renforcés pour SUV, crossovers et 4x4. Résistance aux chocs et crevaisons. Sculptures mixte (route/chemin) ou Mud-Terrain. Flancs protégés et marquage XL (extra load). Stabilité en virage et freinage optimisés.',
                 'image' => 'storage/app/public/categorie_vehicules/pneu_suv_1.jpg',
            ],
             [
                ...
                'image' => 'storage/app/public/categorie_vehicules/pneu_utilitaire_1.jpg',
            ],
            [
                ...
                'image' => 'storage/app/public/categorie_vehicules/pneu_poids_lourds_1.jpg',
            ],
 ...
 [
                ...
                'image' => 'storage/app/public/categorie_vehicules/pneu_moto_1.jpg',
            ],
 ...
 [
                ...
                'image' => 'storage/app/public/categorie_vehicules/pneu_agricole_1.jpg',
            ],
